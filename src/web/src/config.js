...
const auth0Configs = {
  ...
  test: {
    ...
    clientId: "D3ojCydRGRBhjYhV6IummDPRFxP6coPL",
...
let auth0Config = auth0Configs.production;

if (window.location.host == "localhost:8080")
  auth0Config = auth0Configs.development;
else if (window.location.host == "test.hss-backend.ynet.gov.yk.ca")
  auth0Config = auth0Configs.test;
